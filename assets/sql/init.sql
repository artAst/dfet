...
CREATE TABLE pi_heat (heatId INTEGER PRIMARY KEY, heatName VARCHAR(20), is_started INTEGER, heatSession VARCHAR(20), heatTime VARCHAR(20), heatDesc VARCHAR(20), panelId INTEGER, FOREIGN KEY(panelId) REFERENCES pi_panel_info(jobPanelId) ON DELETE CASCADE);
